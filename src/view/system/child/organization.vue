...
<script lang="ts">
  ...
  import { searchAll, update, updateState, del, insert } from '/@/api/system/organization'
    ...
    setup() {
      ...
      const state = reactive({
        ...
        searchSettings: [
          ...
          { placeholder: '请输入机构代码或机构名称', type: 'input', value: 'number' },
          {},
          {},
        ...
        dialogSearch: [
          { label: '机构代码', placeholder: '请输入组织机构代码', type: 'input', value: 'number' },
          { label: '机构名称', placeholder: '请输入组织机构名称', type: 'input', value: 'name' }
        ],
        //search
        add: (val: object) => {
          console.log(val)
