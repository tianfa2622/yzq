  ...
  setup() {
    const state = reactive({
      ...
      searchSettings: [
        ...
        { placeholder: '请输入字典代码或字典名称', type: 'input', value: 'yhmc' },
        {},
        { placeholder: '查询', type: 'search' },
        { placeholder: '新增', type: 'add' }
      ],
      tableHead: [
        { label: '字典类别', prop: 'input' },
        { label: '字典代码', prop: 'input' },
        { label: '字典名称', prop: 'input' },
        { label: '状态', prop: 'input' }
      ],
      ...
      dialogSearch: [
        ...
        { label: '字典编号', placeholder: '请输入字典编号', type: 'input', value: 'yhmc' },
        { label: '字典名称', placeholder: '请输入字典名称', type: 'input', value: 'yhmc' }
      ],
      //search
      add: (val: object) => {
        console.log(val)
